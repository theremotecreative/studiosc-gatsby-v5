  ...
  return (
    <Layout>
      <Seo
        ...
        metaImage={
          pageContent.seo.opengraphImage.localFile.childImageSharp.fluid
        }
      />
      <AnchorLinks>
        ...
        {teamMap.map(teamSrc => (
          <div className="team-member">
            <GatsbyImage
              ...
              image={
                teamSrc.node.featuredImage.node.localFile.childImageSharp
                  .gatsbyImageData
              }
              alt={teamSrc.node.featuredImage.node.title}
            />
...
export const pageQuery = graphql`
  query {
    ...
    sliderContent: allWpStudioSlide(sort: { date: DESC }) {
      edges {
        node {
          featuredImage {
            node {
